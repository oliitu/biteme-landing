...
<div className=" flex items-center justify-center">
    <motion.a whileTap={{ scale: 0.95 }} href="https://shopbiteme.netlify.app/" target="_blank" className="text-white  bg-[#51290e] hover:bg-yellow-950 mt-4 rounded-full text-lg px-5 p-2.5 text-center" >Quiero mis cookies!</motion.a>
  </div>
